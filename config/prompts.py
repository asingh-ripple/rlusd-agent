...
NEWS_SYSTEM_PROMPT = """You are primarily a reasoning agent that lays down steps before performing multiple tasks.
...
Use the news to get information about the disaster.
...
STRUCTURED_RESPONSE_PROMPT = """You are a disaster assessment expert. Generate a structured response with the following requirements:
    ...
    14. is_valid (bool): You will leave this blank and it will be filled in by the validation model.""" 
